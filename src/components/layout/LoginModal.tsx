                      ...
                      <div className="absolute top-full left-0 mt-2 w-72 bg-white border-2 border-yellow-200 rounded-xl shadow-2xl z-50 max-h-80 overflow-y-auto">
                        {COUNTRIES.map((country) => (
                          <button
                            ...
                            className={`w-full px-4 py-3 flex items-center gap-3 hover:bg-yellow-50 transition-colors ${
                              selectedCountry.code === country.code ? 'bg-yellow-100' : ''
                            }`}
                          >
            ...
            <div className="space-y-6">
              <div>
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="text-sm text-gray-600 font-medium bg-yellow-50 px-3 py-1 rounded-full">
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <button 
                  ...
                  className="text-sm font-semibold disabled:text-gray-400 text-yellow-600 hover:text-yellow-700 disabled:cursor-not-allowed transition-colors"
                >
